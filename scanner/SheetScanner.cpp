...
std::vector<FundingOrganization> SheetScanner::scan() {
    std::vector<FundingOrganization> organizations;
    ...
    try {
        ...
        std::unordered_map<std::string, FundingOrganization> organizationMap;
