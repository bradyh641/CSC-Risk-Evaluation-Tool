...
private:
    ...
    std::vector<OrganizationCard> matchedFundingCards;

    std::vector<OrganizationCard> matchedAuditCards;

    std::vector<OrganizationCard> unmatchedFundingCards;
    ...
    float unmatchedFundingScrollOffset = 0.f;

    float unmatchedAuditScrollOffset = 0.f;

    int selectedFundingMatchIndex = -1;
